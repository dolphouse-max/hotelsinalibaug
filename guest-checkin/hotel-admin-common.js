(function () {
  ...
  const HOTEL_TRANSLATIONS = {
    ...
    mr: {
      ...
      nav_drive: "ड्राइव्ह",
      nav_staff: "स्टाफ",
      nav_checkin: "गेस्ट QR",
      nav_payment: "पेमेंट QR",
  ...
  const HOTEL_PAGE_TRANSLATIONS = {
    "/hotel-admin-home.html": {
      ...
      mr: {
        ...
        heroBody: "फ्रंट डेस्कचा वापर सोपा ठेवा. हॉटेल एकदा सेव्ह करा आणि मग प्रत्येक कामासाठी वेगळा page उघडा.",
        loginTitle: "हॉटेल अॅडमिन लॉगिन",
        loginBody: "Superadmin ने Firebase मध्ये तयार केलेल्या hotel admin email आणि password ने लॉगिन करा.",
        ...
        logoutButton: "लॉगआउट",
        taskTitle: "कामाचे पेज",
        taskBadge: "मोबाइलसाठी",
        taskIntro: "मोबाइलवर एकावेळी एकच task page उघडा, म्हणजे reception चे काम सोपे आणि जलद राहील.",
        helpCardTitle: "मदत",
        helpCardBody: "सेटअप, प्रत्येक hotel page, reports, guest register आणि subscription साठी English आणि Marathi मदत उघडा.",
        installTitle: "अॅप इन्स्टॉल करा",
        installBody: "या device वर hotel app इन्स्टॉल करा, म्हणजे full-screen वापर आणि रोजचे काम अधिक सोपे होईल.",
        installButton: "अॅप इन्स्टॉल करा",
        profileTitle: "प्रोफाइल आणि सब्स्क्रिप्शन",
        profileBody: "हॉटेलची माहिती, room count आणि सध्याची active status अपडेट करा.",
        websiteTitle: "वेबसाइट पेज",
        websiteBody: "आपल्या hotel webpage मधील मजकूर आणि फोटो slot बदला. Publish control superadmin कडे राहील.",
        inquiriesTitle: "वेबसाइट चौकशी",
        inquiriesBody: "आपल्या public hotel webpage वरून आलेल्या सर्व inquiries पाहा आणि पाहुण्यांना लगेच संपर्क करा.",
        driveTitle: "Google Drive",
        driveBody: "Guest आणि staff proof image साठी वापरला जाणारा hotel Drive folder connect करा.",
        qrTitle: "गेस्ट QR आणि लिंक",
        qrBody: "Reception साठी guest self-check-in link आणि QR तयार करा.",
        paymentTitle: "सब्स्क्रिप्शन भरा",
        paymentBody: "Payment QR page उघडा आणि कोणत्याही phone वरून subscription भरा.",
        bookingsTitle: "बुकिंग आणि रिझर्वेशन",
        bookingsBody: "या device वर walk-in, future reservation, advance payment आणि arrival/departure plan जतन करा.",
        notificationsTitle: "सूचना",
        notificationsBody: "Browser alert चालू करा आणि subscription reminder किंवा greeting message वाचा.",
        messagesTitle: "हॉटेल मेसेज",
        messagesBody: "जवळच्या हॉटेलशी room availability, overflow guest आणि coordination साठी मेसेज करा.",
        renewalTitle: "नूतनीकरण विनंत्या",
        renewalBody: "Renewal request पाठवा आणि superadmin कडील अलीकडील payments track करा.",
        staffTitle: "स्टाफ नोंदणी",
        staffBody: "Staff onboarding page उघडा आणि hotel context सह staff registration form वर जा.",
        guestsTitle: "गेस्ट चेक-आउट",
        guestsBody: "सध्या राहणारे guest पटकन शोधा आणि room नुसार checkout complete करा.",
        reportsTitle: "रिपोर्ट्स",
        reportsBody: "Check-in, guests, guest register आणि staff साठी hotel-level reports उघडा.",
      },
    },
    "/hotel-reports-home.html": {
      ...
      mr: {
        ...
        heroBody: "रिपोर्ट filters एकदाच सेव्ह करा आणि मग मोबाइलवर एकावेळी एक report page उघडा.",
        intro: "प्रत्येक कामासाठी वेगळा report page वापरा: snapshot, check-ins, current guests, check-outs, guest register किंवा staff register.",
        hotelIdLabel: "हॉटेल आयडी",
        saveButton: "रिपोर्ट filters सेव्ह करा",
        helpTitle: "मदत",
        helpBody: "सेटअप, reports, guest register, staff, payment आणि renewal साठी English आणि Marathi मार्गदर्शन वाचा.",
        snapshotTitle: "हॉटेल स्नॅपशॉट",
        snapshotBody: "Summary metrics, room occupancy, report range आणि trial status.",
        checkinsTitle: "आजचे चेक-इन",
        checkinsBody: "निवडलेल्या हॉटेलचे आज check-in झालेले guest.",
        currentTitle: "सध्याचे गेस्ट",
        currentBody: "फ्रंट डेस्क पाहणीसाठी सध्या राहणारे सर्व guest.",
        checkoutsTitle: "आजचे चेक-आउट",
        checkoutsBody: "आज checkout झालेले guest.",
        registerTitle: "गेस्ट रजिस्टर",
        registerBody: "Search आणि CSV export सह guest history.",
        staffTitle: "स्टाफ रजिस्टर",
        staffBody: "Search आणि CSV export सह staff list.",
      },
    },
    "/hotel-admin-profile.html": {
      ...
      mr: {
        ...
        badge: "प्रोफाइल",
        heroTitle: "प्रोफाइल आणि सब्स्क्रिप्शन",
        heroBody: "आपले हॉटेल खाते तपासा, संपर्क माहिती अद्ययावत ठेवा आणि room count बरोबर आहेत याची खात्री करा.",
        intro: "हा page फक्त hotel details, room count आणि paid-through date तपासण्यासाठी वापरा.",
        sessionLabel: "सेशन",
        hotelIdLabel: "हॉटेल आयडी",
        ...
        adminEmailLabel: "हॉटेल अॅडमिन Gmail",
