      ...
      const result = await context.env.DB.prepare(
        `UPDATE hotel_public_pages
         SET category = ?2,
             ...
             check_in_time = ?25,
             check_out_time = ?26,
             room_count_display = ?27,
             distance_from_beach = ?28,
             distance_from_local_bus_stop = ?29,
             distance_from_alibaug_bus_stand = ?30,
             distance_from_mandwa_jetty = ?31,
             beach_distance_meters = ?32,
             beach_distance_label = ?33,
             room_types_json = ?34,
             amenities_json = ?35,
             faq_json = ?36,
             nearby_places_json = ?37,
             policies_json = ?38,
             inquiry_whatsapp_prefill = ?39,
             canonical_path = ?40,
             is_published = ?41,
             sort_order = ?42,
             last_reviewed_by = ?43,
