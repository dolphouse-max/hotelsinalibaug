      ...
      const result = await context.env.DB.prepare(
        `UPDATE hotel_public_pages
         SET category = ?2,
             ...
             distance_from_beach = ?26,
             distance_from_local_bus_stop = ?27,
             distance_from_alibaug_bus_stand = ?28,
             distance_from_mandwa_jetty = ?29,
             beach_distance_meters = ?30,
             beach_distance_label = ?31,
             room_types_json = ?32,
             amenities_json = ?33,
             faq_json = ?34,
             nearby_places_json = ?35,
             policies_json = ?36,
             inquiry_whatsapp_prefill = ?37,
             canonical_path = ?38,
             is_published = ?39,
             sort_order = ?40,
             last_reviewed_by = ?41,
